...
def regenerate_addresses(apps, schema_editor):
    ...
    from cryptocoins.coins.klc.wallet import create_klc_address
    ...
    wallets = UserWallet.objects.filter(blockchain_currency='KLC')
    count = wallets.count()

    print(f'KLC Wallets regeneration started. Total: {count}')
