...
KLC_SAFE_ADDR = env('KLC_SAFE_ADDR')
...
KLC_CHAIN_ID = 3888
KLC_TX_GAS = 21000
KLC_ACCUMULATION_PERIOD = 60
KLC_BLOCK_GENERATION_TIME = 15
KLC_GAS_PRICE_UPDATE_PERIOD = 60
KLC_GAS_PRICE_COEFFICIENT = 0.1
KLC_MAX_GAS_PRICE = 300000000000
KLC_MIN_GAS_PRICE = 5000000000
...
KLCSCAN_KEY = env('KLCSCAN_KEY', default='')
